            ...
            <div class="col-md-7 p-5">
                ...
                <div class="mb-3">
                    <span class="badge bg-success fs-6 me-2">
                        <i class="bi bi-box-seam"></i> Tồn kho: {{ $product->stock }} sản phẩm
                    </span>
                    <span class="badge bg-primary fs-6">
                        <i class="bi bi-tags"></i> Danh mục: {{ $product->category->name ?? 'N/A' }}
                    </span>
                </div>
                ...
                <div class="mt-4">
                    <div class="d-flex align-items-center gap-3 mb-4">
                        <label for="quantity-{{ $product->id }}" class="fw-semibold">Số lượng</label>
                    ...
                    <button type="button"
                        class="btn btn-lg btn-primary px-4 shadow-sm rounded-3 add-to-cart"
                        data-id="{{ $product->id }}">
